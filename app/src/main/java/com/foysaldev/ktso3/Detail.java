...
public class Detail extends AppCompatActivity {
    ...
    ImageButton ql;
    ListView lvFile;
    private List<Thi> arrayFile = new ArrayList<>();
    private ThiAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AnhXa();
        adapter =new ThiAdapter(this,R.layout.item_file,arrayFile);
    ...
    private void AnhXa() {
        ...
        arrayFile.add(new Thi("Tên Thì","Công Thức","Câu Ví Dụ"));
    }
